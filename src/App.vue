...
import ScreenFourthMainBg from "./components/Images/ScreenFourthMainBg.vue"
import StarIcon from "./components/Images/StarIcon.vue"
</script>
...
<template>
  ...
  <main>
    ...
    <section id="screenFourth">
      ...
      <div class="container">
        <div
          class="d-flex flex-column align-items-center text-center text-white pt-5 mb-4"
        >
          <StarIcon />
        ...
        <div class="d-flex flex-column text-white">
          ...
          <div class="d-flex mb-3">
            ...
            <div>
              ...
              <p class="fs-6">Segment and manage your subscriber base.</p>
            </div>
          </div>
          <div class="d-flex mb-3">
            <img
            ...
            <div>
              ...
              <p class="fs-6">
                Ready-made growth tools for websites, Instagram and Facebook to
                help acquire new subscribers.
              </p>
            </div>
          </div>
          <div class="d-flex mb-3">
          ...
          <div class="d-flex mb-3">
            ...
            <div>
              ...
              <p class="fs-6">
                Respond to clients in different messengers from a single window.
              </p>
            </div>
          </div>
        </div>
